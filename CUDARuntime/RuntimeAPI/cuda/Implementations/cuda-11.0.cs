...
namespace Hybridizer.Runtime.CUDAImports
{
    ...
    public unsafe partial class cuda
    {
...
#endif
        /// <summary>
        /// draft implementation -- SHOULD BE CHECKED !!!!!!
        /// </summary>
		public struct cudaDeviceProp_110
		{
        ...
        private class Cuda_64_110 : ICuda
        {
#if MONO
            internal const string CUDARTDLL = "libcudart.so";
#else
            internal const string CUDARTDLL = "cudart64_110.dll";
#endif
            ...
            public static extern cudaError_t cudaGetDeviceProperties(out cudaDeviceProp_110 props, int device);
            public cudaError_t GetDeviceProperties(out cudaDeviceProp props, int device)
            {
                cudaDeviceProp_110 res;
            ...
            public static extern cudaError_t cudaChooseDevice(out int device, ref cudaDeviceProp_110 prop);
            public cudaError_t ChooseDevice(out int device, ref cudaDeviceProp prop)
            {
                cudaDeviceProp_110 res;
                res = cuda.StructConvert<cudaDeviceProp_110>(prop);
