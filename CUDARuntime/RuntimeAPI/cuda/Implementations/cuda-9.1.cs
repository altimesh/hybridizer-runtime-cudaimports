...
namespace Hybridizer.Runtime.CUDAImports
{
    ...
    public unsafe partial class cuda
    {
        ...
        internal struct cudaDeviceProp_91
        {
            /// <summary>
        ...
        private class Cuda_32_91 : ICuda
        {
...
#else
            internal const string CUDARTDLL = "cudart32_91.dll";
#endif
            ...
            public static extern cudaError_t cudaGetDeviceProperties(out cudaDeviceProp_91 props, int device);
            public cudaError_t GetDeviceProperties(out cudaDeviceProp props, int device)
            {
                cudaDeviceProp_91 res;
            ...
            public static extern cudaError_t cudaChooseDevice(out int device, ref cudaDeviceProp_91 prop);
            public cudaError_t ChooseDevice(out int device, ref cudaDeviceProp prop)
            {
                cudaDeviceProp_91 res;
                res = cuda.StructConvert<cudaDeviceProp_91>(prop);
...
#pragma warning restore 0169
        ...
        private class Cuda_64_91 : ICuda
        {
            ...
            internal const string CUDARTDLL = "libcudart.so";
#else
            internal const string CUDARTDLL = "cudart64_91.dll";
#endif
