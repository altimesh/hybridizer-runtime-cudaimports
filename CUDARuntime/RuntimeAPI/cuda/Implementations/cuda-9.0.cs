...
namespace Hybridizer.Runtime.CUDAImports
{
    ...
    {	
        // updated from CUDA 9.0 
        [StructLayout(LayoutKind.Sequential, Pack = 4)]
        internal struct cudaDeviceProp_90
        {
            /// <summary>
        ...
        internal class Cuda_32_90 : ICuda
        {
#if MONO
            internal const string CUDARTDLL = "libcudart.so";
#else
            internal const string CUDARTDLL = "cudart32_90.dll";
#endif
            ...
            public static extern cudaError_t cudaGetDeviceProperties(out cudaDeviceProp_90 props, int device);
            public cudaError_t GetDeviceProperties(out cudaDeviceProp props, int device)
            {
                cudaDeviceProp_90 res;
            ...
            public static extern cudaError_t cudaChooseDevice(out int device, ref cudaDeviceProp_90 prop);
            public cudaError_t ChooseDevice(out int device, ref cudaDeviceProp prop)
            {
                cudaDeviceProp_90 res;
                res = cuda.StructConvert<cudaDeviceProp_90>(prop);
...
#pragma warning restore 0169
        ...
        internal class Cuda_64_90 : ICuda
        {
#if MONO
            internal const string CUDARTDLL = "libcudart.so";
#else
            internal const string CUDARTDLL = "cudart64_90.dll";
#endif
