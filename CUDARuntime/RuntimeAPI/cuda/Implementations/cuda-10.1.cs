...
namespace Hybridizer.Runtime.CUDAImports
{
    ...
    internal unsafe partial class CudaImplem
    {
        ...
        internal class Cuda_64_101 : ICuda
        {
...
#else
            internal const string CUDARTDLL = "cudart64_101.dll";
#endif
            ...
            public static extern cudaError_t cudaGetDeviceProperties(out cudaDeviceProp_101 props, int device);
            public cudaError_t GetDeviceProperties(out cudaDeviceProp props, int device)
            {
                cudaDeviceProp_101 res;
            ...
            public static extern cudaError_t cudaChooseDevice(out int device, ref cudaDeviceProp_101 prop);
            public cudaError_t ChooseDevice(out int device, ref cudaDeviceProp prop)
            {
                cudaDeviceProp_101 res;
                res = cuda.StructConvert<cudaDeviceProp_101>(prop);
