...
namespace Hybridizer.Runtime.CUDAImports
{
    ...
    internal unsafe partial class CudaImplem
    {
...
#endif
		public struct cudaDeviceProp_100
		{
        ...
        internal class Cuda_32_100 : ICuda
        {
#if MONO
            internal const string CUDARTDLL = "libcudart.so";
#else
            internal const string CUDARTDLL = "cudart32_100.dll";
#endif
            ...
            public static extern cudaError_t cudaGetDeviceProperties(out cudaDeviceProp_100 props, int device);
            public cudaError_t GetDeviceProperties(out cudaDeviceProp props, int device)
            {
                cudaDeviceProp_100 res;
            ...
            public static extern cudaError_t cudaChooseDevice(out int device, ref cudaDeviceProp_100 prop);
            public cudaError_t ChooseDevice(out int device, ref cudaDeviceProp prop)
            {
                cudaDeviceProp_100 res;
                res = cuda.StructConvert<cudaDeviceProp_100>(prop);
...
#pragma warning restore 0169
        ...
        internal class Cuda_64_100 : ICuda
        {
#if MONO
            internal const string CUDARTDLL = "libcudart.so";
#else
            internal const string CUDARTDLL = "cudart64_100.dll";
#endif
