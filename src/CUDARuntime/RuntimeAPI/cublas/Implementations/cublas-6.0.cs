...
namespace Hybridizer.Runtime.CUDAImports
{
    ...
    {
        internal class CUBLAS_32_60 : ICUBLAS
        {
            public const string CUBLAS_DLL = "cublas32_60.dll";

            #region Helper Functions

            [DllImport(CUBLAS_DLL, EntryPoint = "cublasCreate_v2")]
            ...
            [DllImport(CUBLAS_DLL, EntryPoint = "cublasDestroy_v2")]
            ...
            public static extern cublasStatus_t cublasGetVersion(out int version);
            public cublasStatus_t GetVersion(out int version) { return cublasGetVersion(out version); }

            [DllImport(CUBLAS_DLL, EntryPoint = "cublasSetStream_v2")]
            ...
            [DllImport(CUBLAS_DLL, EntryPoint = "cublasSetPointerMode_v2")]
            ...
            [DllImport(CUBLAS_DLL, EntryPoint = "cublasGetPointerMode_v2")]
            ...
            [DllImport(CUBLAS_DLL, EntryPoint = "cublasGetVector_v2")]
            ...
            public cublasStatus_t GetVersion(cublasHandle_t handle, out int version)
            {
        ...
        internal class CUBLAS_64_60 : ICUBLAS
        {
            public const string CUBLAS_DLL = "cublas64_60.dll";
