...
namespace Hybridizer.Runtime.CUDAImports
{
    ...
    {
        internal class CUFFT_32_65 : ICUFFT
        {
            public const string CUFFT_DLL = "cufft_32_65.dll";
            ...
            public static extern cufftResult cufftExecC2C(ref cufftHandle plan, IntPtr idata, IntPtr odata, int direction);
            public cufftResult ExecC2C(cufftHandle plan, IntPtr idata, IntPtr odata, int direction) { return cufftExecC2C(ref plan, idata, odata, direction); }

            [DllImport(CUFFT_DLL, EntryPoint = "cufftExecZ2Z")]
            public static extern cufftResult cufftExecZ2Z(ref cufftHandle plan, IntPtr idata, IntPtr odata, int direction);
            public cufftResult ExecZ2Z(cufftHandle plan, IntPtr idata, IntPtr odata, int direction) { return cufftExecZ2Z(ref plan, idata, odata, direction); }

            [DllImport(CUFFT_DLL, EntryPoint = "cufftExecR2C")]
            public static extern cufftResult cufftExecR2C(ref cufftHandle plan, IntPtr idata, IntPtr odata);
            public cufftResult ExecR2C(cufftHandle plan, IntPtr idata, IntPtr odata) { return cufftExecR2C(ref plan, idata, odata); }

            [DllImport(CUFFT_DLL, EntryPoint = "cufftExecD2Z")]
            public static extern cufftResult cufftExecD2Z(ref cufftHandle plan, IntPtr idata, IntPtr odata);
            public cufftResult ExecD2Z(cufftHandle plan, IntPtr idata, IntPtr odata) { return cufftExecD2Z(ref plan, idata, odata); }
        ...
        internal class CUFFT_64_65 : ICUFFT
        {
            public const string CUFFT_DLL = "cufft_64_65.dll";
